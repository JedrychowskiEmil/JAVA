		...
		<div class="container h-100">
			...
			<div class="row">
				...
				<nav class="navbar navbar-expand-sm w-100 navbar-light"
					...
					<ul class="navbar-nav" style="width: 60%;">
						<li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath}/user/home">Strona
								główna</a></li>
						...
						<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/admin/userlist">Panel
			...
			<div class="row h-100">
				...
				<div class="col-8" style="background-color: rgb(207, 233, 252)">
					...
					<security:authorize access="hasAnyRole('STUDENT')">
							<table class="table table-striped table-hover table-bordered">
								<tr> 
									<th colspan="3">Lista tematów zaproponowanych promotorom</th>
								</tr>
								<tr>
									<th style="width: 40%">Promotor</th>
									<th style="width: 40%">Temat</th>
									<th>Akcja</th>
								</tr>
						<c:forEach var="i" items="${proponowane}">
							<c:url var="deleteLink" value="/user/deletePropozycja">
								...
								<tr>
									...
									onclick="if (!(confirm('Jesteś pewien że chcesz usunąć proponowany temat?'))) return false">Usuń</a></td>
								</tr>
						</c:forEach>
						</table>
					</security:authorize>
				...
				<div class="col-4" style="background-color: rgb(184, 222, 250)">
					...
					<h2> Zmiana Emaila</h2>
					<div style="height: 110px; font-size: 18px">
						<div class="alert alert-primary h-100" role="alert">
						
						<form:form action="changeEmail" modelAttribute="logged" method="POST">
							<div class="form-group">
								<form:input path="email" class="form-control" id="email" placeholder="Wprowadź email"/>
							</div>
